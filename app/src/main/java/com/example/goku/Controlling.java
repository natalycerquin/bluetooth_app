...
public class Controlling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        h = new Handler() {
            public void handleMessage(@SuppressWarnings("NullableProblems") android.os.Message msg) {
                Log.e("Handler ", "1");
                if (msg.what == RECEIVE_MESSAGE) {                                                    // if receive massage
                    ...
                    Log.e("strIncom ", strIncom);
                    sensor_id.setText(strIncom);
    ...
    private class ReadInput implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                //inputStream2 = mBTSocketR.getInputStream();
                while (!bStop) {
